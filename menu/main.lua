...
function zMenuClass:debug_panel_outline(panel,colorr,layer)
    panel:rect({halign = "grow",valign = "grow",h = 1,color = colorr,visible = true,alpha = 0.5,layer = layer or 1000})
    panel:rect({halign = "grow",valign = "grow",y = panel:h()-1,h = 1,color = colorr,visible = true, alpha = 0.5,layer = layer or 1000})
    panel:rect({halign = "grow",valign = "grow",w = 1,color = colorr,visible = true,alpha = 0.5,layer = layer or 1000})
    panel:rect({halign = "grow",valign = "grow",x = panel:w()-1,w = 1,color = colorr,visible = true, alpha = 0.5,layer = layer or 1000})
end
